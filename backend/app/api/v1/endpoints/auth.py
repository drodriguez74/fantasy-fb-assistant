...
async def login(user_credentials: UserLogin):
    """Authenticate user and return access token (demo mode)"""
    # Demo login - accepts any email/password for testing
    if user_credentials.email == "demo@test.com" and user_credentials.password == "Password123":
        # Create demo token
        ...
        raise HTTPException(
            ...
            detail="Use demo@test.com / Password123 for demo login"
        )
