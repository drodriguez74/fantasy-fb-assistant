...
from app.api.v1.endpoints import players, draft, blog, auth, live_draft, users, leagues, content, historical, analytics, waiver_wire, advanced_analysis, game_situations, post_draft, league_scoring, matchup_analysis
...
api_router.include_router(live_draft.router, prefix="/draft/live-draft", tags=["live-draft"])
