...
export function RecommendationCard({ recommendation, onDraftPlayer, rank }: RecommendationCardProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-4 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-blue-700 font-medium">AI Recommendation</span>
        </div>
      ...
      <div className="mb-3">
        <div className="flex items-center gap-2 mb-1">
          <h3 className="font-semibold text-gray-900">{recommendation.player.name}</h3>
          ...
          <span className="text-sm text-gray-500">{recommendation.player.team}</span>
        </div>
