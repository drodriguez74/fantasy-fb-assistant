    ...
    return (
      <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            {showCharts && (
              <div className="flex items-center space-x-2">
                <label className="text-sm text-body">Chart Type:</label>
                <select
                  value={chartType}
        ...
        <div className="bg-highlight rounded-lg p-4">
          <h3 className="text-lg font-semibold text-accent-ink mb-3">Key Insights</h3>
          <ul className="space-y-2">
            {comparisonResult.insights.map((insight, index) => (
              <li key={`comparison-insight-${index}-${insight.slice(0, 20)}`} className="text-accent-ink">• {insight}</li>
            ))}
          </ul>
        </div>
          ...
          <div className="bg-surface rounded-lg border border-hairline p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.entries(comparisonResult.head_to_head.categories || {}).map(([category, data]) => (
                <div key={category} className="flex items-center justify-between p-3 bg-surface-2 rounded-lg">
            ...
            <div key={player.id} className="bg-surface rounded-lg border border-hairline p-6">
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-muted">Projected Points:</span>
                ...
                {player.risk_assessment.risk_factors.length > 0 && (
                  <div className="mt-3">
                    <span className="text-sm font-medium text-body">Risk Factors:</span>
        ...
        {/* Recommendation */}
        <div className="bg-highlight rounded-lg p-4">
          <h3 className="text-lg font-semibold text-accent-ink mb-2">Recommendation</h3>
          <p className="text-accent-ink">{comparisonResult.recommendation}</p>
        </div>
      </div>
    )
  }
        ...
        <div className="bg-surface rounded-lg border border-hairline p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{scheduleResult.summary.easiest_schedule ?? '—'}</div>
              <div className="text-xs uppercase text-muted">Easiest Schedule</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{scheduleResult.summary.hardest_schedule ?? '—'}</div>
              <div className="text-xs uppercase text-muted">Hardest Schedule</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{scheduleResult.summary.average_difficulty ?? '—'}</div>
              <div className="text-xs uppercase text-muted">Average Difficulty</div>
            </div>
          </div>
            ...
            <div key={analysis.player.id} className="bg-surface rounded-lg border border-hairline p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-4">
                  {analysis.schedule_difficulty.rank !== null && (
                    <span className="px-2 py-1 bg-surface-2 text-muted text-sm rounded-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                {analysis.upcoming_matchups.map((matchup, idx: number) => (
                  <div key={idx} className="text-center p-3 bg-surface-2 rounded-lg">
                    <div className="font-semibold">Week {matchup.week}</div>
                    <div className="text-sm text-muted">{matchup.opponent}</div>
              ...
              <div className="bg-highlight p-3 rounded-lg">
                <span className="text-sm font-medium text-accent-ink">Recommendation: </span>
                <span className="text-sm text-accent-ink">{analysis.recommendation}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-surface rounded-lg border border-hairline p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{breakoutResult.summary.total_candidates}</div>
              <div className="text-xs uppercase text-muted">Total Candidates</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{breakoutResult.summary.high_probability}</div>
              <div className="text-xs uppercase text-muted">High Probability</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{breakoutResult.summary.medium_probability}</div>
              <div className="text-xs uppercase text-muted">Medium Probability</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-semibold text-body">{(breakoutResult.summary.average_probability * 100).toFixed(1)}%</div>
              <div className="text-xs uppercase text-muted">Avg Probability</div>
            </div>
          </div>
        </div>
          ...
          {breakoutResult.breakout_candidates.slice(0, 10).map((candidate) => (
            <div key={candidate.player.id} className="bg-surface rounded-lg border border-hairline p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-highlight p-3 rounded-lg">
                  <span className="text-sm font-medium text-accent-ink">Recommendation: </span>
                  <span className="text-sm text-accent-ink">{candidate.recommendation}</span>
                </div>
              </div>
            </div>
          ))}
    ...
    return (
      <div className="space-y-6">
          ...
          <div className="bg-highlight rounded-lg p-4">
            ...
            <ul className="space-y-2">
              {situationResult.comparison_insights.map((insight, index) => (
                <li key={`situation-insight-${index}-${insight.slice(0, 20)}`} className="text-accent-ink">• {insight}</li>
              ))}
            </ul>
          </div>
        )}
            ...
            return (
              <div key={analysis.player.id} className="bg-surface rounded-lg border border-hairline p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Home vs Away</h4>
                    ...
                    {ha && ha.home_performance.games > 0 && ha.away_performance.games > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Prefers: {ha.advantage}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">Not enough logged home/away games for this player yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Weather Impact</h4>
                    ...
                    {domeVsOutdoor && domeVsOutdoor.dome_performance.games > 0 && domeVsOutdoor.outdoor_performance.games > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Sensitivity: {wa?.weather_sensitivity}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">No logged weather/venue data for this player yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Opponent Strength</h4>
                    ...
                    {oa && Object.keys(oa.defense_strength_performance).length > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Dependency: {oa.matchup_dependency}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">Not enough logged opponent-strength data yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Game Script</h4>
                    ...
                    {ga && Object.keys(ga.game_script_performance).length > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Dependency: {ga.script_dependency}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">No logged game-script data for this player yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Red Zone Usage</h4>
                    ...
                    {ga && ga.red_zone_analysis.data_confidence === 'computed' ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">TD dependency: {ga.red_zone_analysis.touchdown_dependency}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">{ga?.red_zone_analysis.note ?? 'No logged red-zone usage data yet.'}</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Prime Time</h4>
                    ...
                    {pt && pt.sample_sizes.prime_time > 0 && pt.sample_sizes.regular > 0 ? (
                      ...
                      <div className="text-sm text-muted">Not enough logged prime-time games yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Division Rivalry</h4>
                    ...
                    {rv && rv.rivalry_performance.games > 0 && rv.non_rivalry_performance.games > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Factor: {rv.emotional_factor}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">Not enough logged rivalry-game data yet.</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Altitude Impact</h4>
                    ...
                    {va && va.altitude_impact.altitude_impact !== null ? (
                      ...
                      <div className="text-sm text-muted">{va?.altitude_impact.note ?? 'No logged high-altitude venue data yet.'}</div>
                    )}
                  </div>
                  ...
                  <div className="bg-surface-2 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-body">Upcoming Weeks</h4>
                    ...
                    {analysis.upcoming_situation_forecast.next_4_weeks.length > 0 ? (
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="font-medium text-accent-ink">Outlook: {analysis.upcoming_situation_forecast.overall_outlook}</div>
                      </div>
                    ) : (
                      <div className="text-sm text-muted">{analysis.upcoming_situation_forecast.note ?? 'No synced schedule data yet.'}</div>
                    )}
                  </div>
                </div>
                ...
                {oa && oa.upcoming_opponents.length > 0 && (
                  <div className="mt-4 bg-surface-2 p-3 rounded-lg">
                    <span className="text-sm font-medium text-body">Upcoming Opponents: </span>
                ...
                {analysis.situational_insights.length > 0 && (
                  <div className="mt-4 bg-highlight p-3 rounded-lg">
                    <span className="text-sm font-medium text-accent-ink">Situational Insights: </span>
                    <ul className="mt-1 text-sm text-accent-ink">
        ...
        {situationResult.recommendations.length > 0 && (
          <div className="bg-highlight rounded-lg p-4">
            <h3 className="text-lg font-semibold text-accent-ink mb-2">Recommendations</h3>
            <ul className="space-y-1">
              {situationResult.recommendations.map((rec, index) => (
                <li key={`situation-rec-${index}-${rec.slice(0, 20)}`} className="text-accent-ink">• {rec}</li>
              ))}
            </ul>
          </div>
        )}
  ...
  if (!user) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-1 text-sm text-muted">Please log in to access Advanced Analysis features.</p>
      </div>
    )
  }
      ...
      <div className="bg-surface rounded-lg border border-hairline p-6">
        ...
        <div className="relative mb-4">
          ...
          {playerSuggestions.length > 0 && (
            <div className="absolute z-10 w-full mt-1 bg-surface border border-line rounded-md max-h-60 overflow-y-auto">
              {playerSuggestions.map((player) => (
                <button
                  key={player.id}
                  onClick={() => addPlayer(player)}
                  className="w-full text-left px-4 py-2 hover:bg-surface-2 flex items-center justify-between"
                >
                  <div>
                    <div className="font-medium">{player.name}</div>
                    <div className="text-sm text-muted">{player.position} - {player.team}</div>
                  </div>
                  <PlusIcon className="h-4 w-4 text-accent-ink" />
                </button>
              ))}
            </div>
          )}
        ...
        {selectedPlayers.length > 0 && (
          <div className="mb-4">
            <h3 className="text-sm font-medium text-body mb-2">Selected Players ({selectedPlayers.length}/5)</h3>
        ...
        <div className="p-6">
          {activeTab === 'comparison' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-body">Player Comparison</h3>
                  <p className="text-muted">Compare up to 5 players across multiple metrics</p>
                </div>
                <button
          ...
          {activeTab === 'schedule' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-body">Strength of Schedule</h3>
                  <p className="text-muted">Analyze upcoming matchup difficulty</p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    <label className="text-sm font-medium text-body">Weeks Ahead:</label>
                    <select
                      value={weeksAhead}
          ...
          {activeTab === 'breakout' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-body">Breakout Candidates</h3>
                  <p className="text-muted">Low-owned players trending up based on age, usage, and recent performance</p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    <label className="text-sm font-medium text-body">Position:</label>
                    <select
                  ...
                  <div className="flex items-center space-x-2">
                    <label className="text-sm font-medium text-body">Max Ownership:</label>
                    <select
                      value={maxOwnership}
          ...
          {activeTab === 'situations' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-body">Game Situation Analysis</h3>
                  <p className="text-muted">Performance across different game contexts</p>
                </div>
                <button
